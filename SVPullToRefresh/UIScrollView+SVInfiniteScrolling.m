...
//          //mdee: hi! commented this out cause this is causing problems! some messages are below the scrollview view when keyboard dismisses or when recording voice message
...
- (void)setScrollViewContentInsetForInfiniteScrolling {
    NSLog(@"setScrollViewContentInsetForInfiniteScrolling");
...
- (void)setScrollViewContentInset:(UIEdgeInsets)contentInset {
    NSLog(@"NEW content inset: %@", NSStringFromUIEdgeInsets(contentInset));
...
- (void)observeValueForKeyPath:(NSString *)keyPath ofObject:(id)object change:(NSDictionary *)change context:(void *)context {
    if([keyPath isEqualToString:@"contentInset"]) {
        NSLog(@"observe content inset: %@", change);
    }
...
//        NSLog(@"contentsize changed: %@", NSStringFromCGSize(self.scrollView.contentSize));
        [self layoutSubviews];
...
- (void)scrollViewDidScroll:(CGPoint)contentOffset {
    if(self.state != SVInfiniteScrollingStateLoading) {
        ...
        switch (self.position) {
            ...
            case SVInfiniteScrollingPositionBottom:
                //
                //masdee: commented out this part because when there is a footer view, nagkaka-extra space sa baba when loading messages. changed to resetScrollViewContentInset below
                //
                
//                NSLog(@"SVInfiniteScrollingPositionBottom");
